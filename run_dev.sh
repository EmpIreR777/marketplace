...
# Обработка backend
copy_env_file_force "backend/.env.dev" "backend/.env" "Backend"

# Обработка frontend
copy_env_file_force "frontend/.env.dev" "frontend/.env" "Frontend"
...
# Включение логов
docker compose -f docker-compose-dev.yml logs -f No newline at end of file